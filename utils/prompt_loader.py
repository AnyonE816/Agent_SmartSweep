...
def load_system_prompts():
    ...
    try:
        ...
        logger.error(f"[load_system_prompts]读取系统提示词出错，str(e)")
        raise e
...
def load_rag_prompts():
    ...
    try:
        ...
        logger.error(f"[load_rag_prompts]读取RAG总结提示词出错，str(e)")
        raise e
...
def load_report_prompts():
    ...
    try:
        ...
        logger.error(f"[load_report_prompts]读取报告生成提示词出错，str(e)")
        raise e
